...
def insert_single_data_cass():
    ...
    query = "INSERT INTO {}.{}({},{},{},{},{},{},{},{}) values(%s,%s,%s,%s,%s,%s,%s,%s);".format(database_name,table_name,column1_name,column2_name,column3_name,column4_name,column5_name,column6_name,column7_name,column8_name)
    session.execute(query,[data_value1,data_value2,data_value3,data_value4,data_value5,data_value6,data_value7,data_value8])
    return "Data inserted"
...
@app.route('/cassandra/insert_multiple_data', methods=['POST'])
def insert_multiple_data_cass():
    database_name = request.json['database_name']
    table_name = request.json['table_name']
    file_path = request.json['file_path'] # E:\\Full_Stack_data_science\\Python\\mySQL\\19.2.MySQL\\Imp files\\estonia-passenger-list.csv
    delimiter = request.json['delimiter']
    ...
    with open(file_path,'r') as data:
        ...
        query = "insert into {}.{}({},{},{},{},{},{},{},{}) values(%s,%s,%s,%s,%s,%s,%s,%s)".format(database_name,table_name,column1_name,column2_name,column3_name,column4_name,column5_name,column6_name,column7_name,column8_name)
        for i in data_csv:
            session.execute(query,[int(i[0]), str(i[1]), str(i[2]), str(i[3]), str(i[4]), int(i[5]), str(i[6]), int(i[7])])
    return "Done inserting multiple data inside the table"
    # {
    #     "database_name": "first_test",
    #     "table_name": "passenger_details",
    #     "file_path": "E:\\Full_Stack_data_science\\Python\\mySQL\\19.2.MySQL\\Imp files\\estonia-passenger-list.csv",
...
def update_data_cass():
    ...
    query = "UPDATE {}.{} SET {}=%s WHERE {}=%s;".format(database_name,table_name,column_name,where_column)
    args = [data_value,where_data]
...
def download_data_cass():
    database_name = request.json['database_name']
    table_name = request.json['table_name']
    file_path = request.json['file_path'] # E:\\Full_Stack_data_science\\Python\\flask
    file_name = request.json['file_name'] # passengers_details_cass
    ...
    for i in table_all:
        writer.writerow(i)
    file.close()
    return "Done downloading the table data"
    # {
    #     "database_name": "first_test",
    #     "table_name": "passenger_details",
    #     "file_path": "E:\\Full_Stack_data_science\\Python\\flask",
    #     "file_name": "passengers_details_cass"
    # }
